...
<div className="container relative" ref={parallaxRef}>
  <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
    <h1 className="mb-6 h1">
      ...
      <span className="relative inline-block">
         Brainwave <img src={curve} className="absolute left-0 w-full top-full xl:-mt-2 " width={624} height={28} alt="Curve"/>
      </span>
    </h1>
  ...
  <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
    <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
      <div className="relative rounded bg-n-8-[1rem]">
        ...
        <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]"> 
          ...
          <ScrollParallax isAbsolutelyPositioned>
            <Notification
            className="absolute hidden xl:flex -right-[5.5rem] bottom-[11rem] w-[18rem]" title="code generating"
             />
          </ScrollParallax>
        </div>
      </div>
